...
export default function GridCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setStitch(initialValues.stitch);
    setOffset(initialValues.offset);
    setLinebold(initialValues.linebold);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Grid0(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GridCreateForm")}
      {...rest}
    >
      <TextField
        label="Fname"
